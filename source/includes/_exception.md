...
## InspetorCategoryException

This exception is thrown when you provide an [InspetorCategory](#inspetorcategory) object with invalid properties or missing required properties
...
7005 | billing_address is a required property. It can't be null
...
## InspetorSessionException

This exception is thrown when you provide an [InspetorSession](#inspetorsession) object with invalid properties or missing required properties
...
-------- | ------
7001 | id is a required property. It must not be null
7002 | datetime is a required property. It must not be null
